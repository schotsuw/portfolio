  ...
  export const projects = [
    {
      ...
      description:
        "I wanted to learn about the full stack development and I have a strong interest to skincare products especially Korean and Japanese Skincare. So, I developed a full-stack responsive E-commerce application using MERN stack to provide a platform for users to browse, purchase, and review skincare products. I also built an admin page that can add, remove, and update the products",
      image:
        skincare,
      tags: [
        "React Js",
      ...
      category: "web app",
      github: "https://github.com/schotsuw/E-Commerce-Skincare-new-main",
      webapp: "https://664bf4660d17a8576d5c2fe6--starlit-cat-1907a2.netlify.app/",
    },
    {
      id: 0,
      title: "Responsive Portforlio",
      date: "July 2024",
      description:
        "This portfolio represents my skills, experiences, as well as projects. I built this web by using React framework and use Git to push the code into GitHub.",
      image:
        portfolio,
    ...
    {
      id: 1,
      title: "Shooting Celebrities Space Invader",
      date: "January 2024",
      description:
        "This project is my most fun and favorite one. Well, I wanted to build a game that is funny, and I love Space Invader, so I developed a 2D Space Invader Game using Python with PyGame library.",
      image:
        shooting,
      tags: [
        "Python",
